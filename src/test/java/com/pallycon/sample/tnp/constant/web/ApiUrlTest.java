...
class ApiUrlTest {
    ...
    void getUrl_should_return_with_single_param() {
        ...
        String expected = "https://tnp.pallycon.com/api/token/TEST";
    ...
    void getUrl_should_return_with_multi_param() {
        ...
        String expected = "https://tnp.pallycon.com/api/job/TEST/777";
    ...
    void getUrl_should_return_different_when_param_order_changes() {
        ...
        // then
        assertThat(url1).isEqualTo("https://tnp.pallycon.com/api/job/TEST/777");
        assertThat(url2).isEqualTo("https://tnp.pallycon.com/api/job/777/TEST");
    ...
    void getUrl_should_throw_exception_when_param_count_is_invalid() {
        ...
        assertThatThrownBy(() -> ApiUrl.GET_JOB_DETAIL.getUrl(siteId))
                ...
                .hasMessageContaining("URL 패턴에 필요한 파라미터 개수와 입력된 파라미터 개수가 다릅니다.");
    }
}